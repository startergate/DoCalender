...
<html lang="ko">
  <head>
    ...
    <title>비밀번호 수정 | DoCalender</title>
  </head>
  <body>
    <div class="container-fluid padding-erase">
      <div class="fixed layer1 bg bgi bgImg">
        <div class="col-md-3">
          <a href="../calender.php"><img src="../static/img/common/donotevec.png" alt="DoCalender" class="img-rounded" id=logo alt='메인으로 가기' \></a>
        </div>
    ...
    <div class="container-fluid layer2" id="padding-generate-top" style="margin-top: 50px; z-index: 1">
      <div class="col-md-2">
        <ol class="nav" nav-stacked="" nav-pills="">
          ...
          <li><a href="../calender.php">캘린더로 돌아가기</li></a>
        </ol>
      </div>
